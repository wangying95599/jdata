...
# test code
Data = DataLoader(
				FILE_jdata_sku_basic_info='../input/jdata_sku_basic_info.csv',
				FILE_jdata_user_action='../input/jdata_user_action.csv',
				FILE_jdata_user_basic_info='../input/jdata_user_basic_info.csv',
				FILE_jdata_user_comment_score='../input/jdata_user_comment_score.csv',
				FILE_jdata_user_order='../input/jdata_user_order.csv'
			)
